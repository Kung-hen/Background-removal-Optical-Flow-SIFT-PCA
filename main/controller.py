...
class Form_controller(QtWidgets.QWidget):
    ...
    def detect(self):
        ...
        corners = cv2.goodFeaturesToTrack(
            gray_frame, maxCorners=1, qualityLevel=0.3, minDistance=7, blockSize=7
        )
        ...
        if corners is not None:
            ...
            for i in corners:
                x, y = i.ravel()
                detected = (x, y)
                cv2.line(frame, (x - 20, y), (x + 20, y), (0, 0, 255), 5)
                cv2.line(frame, (x, y - 20), (x, y + 20), (0, 0, 255), 5)
    ...
    def track(self):
        ...
        while True:
            ...
            for i, (new, old) in enumerate(zip(good_new, good_old)):
                ...
                frame = cv2.line(frame, (a - 20, b), (a + 20, b), (0, 0, 255), 5)
                frame = cv2.line(frame, (a, b - 20), (a, b + 20), (0, 0, 255), 5)
